 ...
 * Manifest 파일에 자동으로 `Add-Opens: java.base/java.lang=ALL-UNNAMED` 옵션을 추가해주기 때문에
 * 별도로 설정하지 않아도 됩니다.
 */
@Disabled(
    """
...
class CglibTest {
    @Test
    @DisplayName("CGLIB 이용한 클래스 생성")
    fun create_class_with_CGLIB() {
        // Given
    ...
    @Test
    @DisplayName("CGLIB 이용한 클래스 프록시 생성")
    fun create_proxy_with_CGLIB() {
        // Given
        val enhancer = Enhancer()
